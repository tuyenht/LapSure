...
| Exterior and structure | Cracks, dents, impact damage, chassis gaps, loose/over-tight hinge, stripped/missing screws, suspicious disassembly | Guided physical checklist with operator confirmation and optional photos | Implemented, physical validation pending | Physical Condition Wizard covers chassis, hinge, tamper, liquid/corrosion, battery swelling and charger safety. Missing/skipped evidence blocks BUY. Optional photos and multi-operator validation remain. |
