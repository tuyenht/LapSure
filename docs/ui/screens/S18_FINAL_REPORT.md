...
visual_reference: S18_FINAL_REPORT.jpg
components: [C01, C02, C03, C04, C05, C06, C08, C10, C12]
```

## 1. User outcome
Explain the evidence-gated purchase recommendation and what remains uncertain.
...
|---|---|---|
| S18-O01 | Recommendation | Bind to real data/state; unavailable stays explicit |
| S18-O02 | Required coverage | Bind to real data/state; unavailable stays explicit |
| S18-O03 | Confidence | Bind to real data/state; unavailable stays explicit |
| S18-O04 | Critical failures | Bind to real data/state; unavailable stays explicit |
| S18-O05 | Warnings | Bind to real data/state; unavailable stays explicit |
| S18-O06 | Seller/factory mismatches | Bind to real data/state; unavailable stays explicit |
| S18-O07 | Unchecked/unsupported required items | Bind to real data/state; unavailable stays explicit |
| S18-O08 | Reasons | Bind to real data/state; unavailable stays explicit |
| S18-O09 | Negotiation notes after technical truth | Bind to real data/state; unavailable stays explicit |

## 5. Data sources
- `AuditDecision`
- `CoverageDomain`
- `Findings`
- `SellerClaim comparison`
...
**Required incomplete coverage blocks clean BUY. Keep recommendation, coverage and confidence separate.**

## 9. Visual contract
Primary reference: `../references/approved/S18_FINAL_REPORT.jpg`
