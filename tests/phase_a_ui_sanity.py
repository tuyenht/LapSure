...
checks = [
    ...
    ("Round 5 production entry is compiled", "src/main_round5.cpp" in cm),
    ("No hardcoded fake health score 88/100 in app source", "DrawCircularScoreGauge" not in main_cpp),
    ("No hardcoded fake factory match 95% in app source", 'L"Khớp cấu hình nhà máy:  95%"' not in main_cpp),
]
